    ...
    def do_testing(self, file_name):
        ...
        with open(file_name) as f:
            ...
            for test in test_data['tests']:
                ...
                actusl_result = self.connector.execute(query)

                if actusl_result == expected_result:
                    self.logger.add_pass(query, actusl_result)
                else:
                    self.logger.add_fail(query, actusl_result, expected_result)
